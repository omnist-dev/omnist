...
For more worked examples — real external formats rather than one
designed for Omnist, including where OSD's algebra hits real limits —
see [the four-example overview](examples/index.md).
...
- [Document Model](https://spec.omnist.dev/02-document-model/) / [Schema Model](https://spec.omnist.dev/03-schema-model/) chapters of spec.omnist.dev — the formal definitions.
